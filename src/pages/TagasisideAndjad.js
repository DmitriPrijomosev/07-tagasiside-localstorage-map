...
function TagasisedeAndjad() {
  ...
  const filtreeri6 = () => {
    const vastus6 = andjad.filter((element) => element.length === 6);
  ...
  return (
    <div>
      ...
      <button onClick={() => filtreeriM()}>
        Filtreri ehk jätta kõik M tähega algavad nimed alles
      </button>
      <br />
      <button onClick={() => filtreeri6()}>
        Filtreeri ehk jätta kõik täpselt 6 kohalised nimed alles
      </button>
      <br />
      <button onClick={() => filtreeriY()}>
        Filtreeri ehk jätta kõik Y tähega lõpevad nimed alles
      </button>
      <br />
      ...
      <br />
      <button>
        Kuva tähestikus esimene, kellel on D tähega algav nimi. Console või HTML
      </button>
      <br />
      {andjad.map( element => 
